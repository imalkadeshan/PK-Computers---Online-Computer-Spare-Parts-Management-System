...
/* Header and Navbar are outside main content */
...
<body>
    ...
    <div class="main-content-wrapper">
        <div class="update-form-container">
            ...
            <form action="updateSupplierServlet" method="post" onsubmit="return validateForm()">
                ...
                <div class="profile-actions">
                    ...
                    <a href="supplierDashboardServlet" class="btn cancel">Cancel</a>
                    <button type="button" class="btn delete" onclick="if(confirmDelete()) { location.href='deleteSupplierServlet'; }">Delete Account</button>
                </div>
            </form>
        </div>
    </div>
